...
-- 24. Auditoría
INSERT INTO auditoria (id, tabla_afectada, id_registro, operacion, datos_anteriores, datos_nuevos, usuario_id, fecha) VALUES
(1, 'practica', 1, 'INSERT', NULL, '{"empresa_id":1,"estudiante_id":1}', 2, '2023-01-15 08:00:00'),
(2, 'evaluacion', 1, 'INSERT', NULL, '{"calificacion":4,"evaluador":"JEFE"}', 3, '2023-03-16 10:05:00'),
(3, 'expediente_practica', 1, 'UPDATE', '{"estado_doc":"PENDIENTE"}', '{"estado_doc":"APROBADO"}', 2, '2023-01-17 09:30:00'),
(4, 'estudiante', 3, 'UPDATE', '{"activo":true}', '{"activo":false}', 1, '2023-05-12 11:20:00'),
(5, 'docente', 5, 'INSERT', NULL, '{"nombre":"Luis","apellido":"Rodríguez"}', 1, '2023-02-10 14:15:00'),
(6, 'asignatura', 2, 'UPDATE', '{"creditos":3}', '{"creditos":4}', 2, '2023-04-05 10:45:00'),
(7, 'usuario', 7, 'DELETE', '{"correo":"jefe1@empresa.com"}', NULL, 1, '2023-03-20 16:30:00'),
(8, 'empresa', 4, 'INSERT', NULL, '{"nombre":"Servicios Integrales"}', 2, '2023-01-10 09:10:00'),
(9, 'visita_seguimiento', 5, 'UPDATE', '{"observaciones":"Demuestra iniciativa"}', '{"observaciones":"Demuestra gran iniciativa"}', 3, '2023-04-16 11:25:00'),
(10, 'reporte_academico', 6, 'INSERT', NULL, '{"promedio_acumulado":4.5}', 2, '2023-01-05 13:40:00');